...
2. Makine Öğrenmesi Nedir? Fonksiyonel Örnek
...
5. Temel Kavramlar 2
   + Temel Kavramlar 2
6. Model Doğrulama Yöntemleri
   + Model Doğrulama Yöntemleri
7. Model Başarı Değerlendirme Yöntemleri
...
1. Giriş
   + Giriş
2. K En Yakın Komşu
   + K En Yakın Komşu Giriş
   + K En Yakın Komşu
   + K En Yakın Komşu Model ve Tahmini
   + K En Yakın Komşu Model Tuning
3. Destek Vektör Regresyonu
   + Destek Vektör Regresyonu Giriş
...
4. Destek Vektör Makineleri
   + Destek Vektör Makineleri Giriş
...
**Eğitim Adı:** Makine Öğrenmesi 101 & 201 & 301 & 401 & 501 (Machine Learning 101 & 201 & 301 & 401 & 501)
